...
namespace Neo.Cryptography.BLS12_381
{
    ...
    {
        [DllImport("Neo_BLS12_381_Native", CallingConvention = CallingConvention.Cdecl)]
    ...
    internal class GObject
    {
        ...
        public static IntPtr Add(GObject p1, GObject p2)
        {
            ...
            {
                GType.G1 => Bls12381Wrapper.g1_add(p1.ptr, p2.ptr),
                GType.G2 => Bls12381Wrapper.g2_add(p1.ptr, p2.ptr),
                GType.Gt => Bls12381Wrapper.gt_add(p1.ptr, p2.ptr),
        ...
        public GObject Neg()
        {
            ptr = type switch
            {
                GType.G1 => Bls12381Wrapper.g1_neg(ptr),
                GType.G2 => Bls12381Wrapper.g2_neg(ptr),
                GType.Gt => Bls12381Wrapper.gt_neg(ptr),
                _ => throw new Exception($"Bls12381 operation fault, type:format, error:valid point length")
            };
            return this;
        }
        ...
        public static IntPtr Mul(GObject p, UInt64 x)
        {
            ...
            {
                GType.G1 => Bls12381Wrapper.g1_mul(p.ptr, x),
                GType.G2 => Bls12381Wrapper.g2_mul(p.ptr, x),
                GType.Gt => Bls12381Wrapper.gt_mul(p.ptr, x),
        ...
        ~GObject()
        {
            try
            {
                ...
                {
                    case GType.G1:
                        Bls12381Wrapper.g1_dispose(ptr);
                        break;
                    case GType.G2:
                        Bls12381Wrapper.g2_dispose(ptr);
                        break;
                    case GType.Gt:
                        Bls12381Wrapper.gt_dispose(ptr);
                        break;
                    default:
                        throw new Exception($"Bls12381 operation fault, type:format, error:type mismatch");
                }
